...
RUN wget https://github.com/lay295/TwitchDownloader/releases/download/1.52.3/TwitchDownloaderCLI-1.52.3-LinuxAlpine-x64.zip && unzip TwitchDownloaderCLI-1.52.3-LinuxAlpine-x64.zip
