...
RUN wget https://github.com/lay295/TwitchDownloader/releases/download/1.53.0/TwitchDownloaderCLI-1.53.0-LinuxAlpine-x64.zip && unzip TwitchDownloaderCLI-1.53.0-LinuxAlpine-x64.zip
...
RUN pip3 install --no-cache --upgrade pip streamlink yt-dlp
