...
RUN wget https://github.com/lay295/TwitchDownloader/releases/download/1.50.5/TwitchDownloaderCLI-LinuxAlpine-x64.zip && unzip TwitchDownloaderCLI-LinuxAlpine-x64.zip
