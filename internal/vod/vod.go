...
// GetVod gets a VOD by it's ID optionally returning the channel, chapters, and muted segments.
func (s *Service) GetVod(ctx context.Context, vodID uuid.UUID, withChannel bool, withChapters bool, withMutedSegments bool) (*ent.Vod, error) {
