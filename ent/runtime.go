...
func init() {
	...
	// liveDescVodResolution is the schema descriptor for vod_resolution field.
	liveDescVodResolution := liveFields[10].Descriptor()
	// live.DefaultVodResolution holds the default value on creation for the vod_resolution field.
	live.DefaultVodResolution = liveDescVodResolution.Default.(string)
	// liveDescClipResolution is the schema descriptor for clip_resolution field.
	liveDescClipResolution := liveFields[11].Descriptor()
	// live.DefaultClipResolution holds the default value on creation for the clip_resolution field.
	live.DefaultClipResolution = liveDescClipResolution.Default.(string)
	// liveDescLastLive is the schema descriptor for last_live field.
	liveDescLastLive := liveFields[12].Descriptor()
	...
	liveDescRenderChat := liveFields[13].Descriptor()
	...
	liveDescVideoAge := liveFields[14].Descriptor()
	...
	liveDescApplyCategoriesToLive := liveFields[15].Descriptor()
	...
	liveDescStrictCategoriesLive := liveFields[16].Descriptor()
	...
	liveDescBlacklistCategories := liveFields[17].Descriptor()
	...
	liveDescWatchClips := liveFields[18].Descriptor()
	...
	liveDescClipsLimit := liveFields[19].Descriptor()
	...
	liveDescClipsIntervalDays := liveFields[20].Descriptor()
	...
	liveDescClipsIgnoreLastChecked := liveFields[22].Descriptor()
	...
	liveDescUpdateMetadataMinutes := liveFields[23].Descriptor()
	...
	liveDescUpdatedAt := liveFields[24].Descriptor()
	...
	liveDescCreatedAt := liveFields[25].Descriptor()
	...
	vodDescLocalViews := vodFields[33].Descriptor()
	...
	vodDescSpriteThumbnailsEnabled := vodFields[34].Descriptor()
	...
	vodDescStorageSizeBytes := vodFields[41].Descriptor()
	...
	vodDescStreamedAt := vodFields[42].Descriptor()
	...
	vodDescUpdatedAt := vodFields[43].Descriptor()
	...
	vodDescCreatedAt := vodFields[44].Descriptor()
