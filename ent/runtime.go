...
func init() {
	...
	vodDescLocked := vodFields[26].Descriptor()
	...
	vodDescLocalViews := vodFields[27].Descriptor()
	...
	vodDescStreamedAt := vodFields[28].Descriptor()
	...
	vodDescUpdatedAt := vodFields[29].Descriptor()
	...
	vodDescCreatedAt := vodFields[30].Descriptor()
