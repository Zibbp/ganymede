...
func (Live) Fields() []ent.Field {
	fields := []ent.Field{
		...
		field.String("resolution").Default("best").Optional().Comment("Live stream archive quality."),
		field.String("vod_resolution").Default("best").Optional().Comment("Video archive quality."),
		field.String("clip_resolution").Default("best").Optional().Comment("Clip archive quality."),
